        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800 text-center">Form Data Users</h1>
                    <p class="mb-4 text-center">Pengecekan data secara rutin akan terciptanya konsistensi data yang baik</p>

                    <!-- DataTales Example -->
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary text-left">Form Edit Data Users </h6>
                        </div>
                        <div class="card-body">
                                          ...
                                          <div class="row">
                                            <div class="col-md-6">
                                              ...
                                              <div class="form-group">
                                                ...
                                                <?php echo form_input('nama_user', $users['nama_user'],
                                              ...
                                              <div class="form-group">
                                                ...
                                                <?php echo form_input('username', $users['username'], 
                                            ...
                                            <div class="col-md-6">
                                              <div class="form-group">
                                                ...
                                                <?php echo form_input('password', $users['password'], 
                                               ...
                                               <div class="form-group">
                                                ...
                                                <?php echo form_input('level', $users['level'], 
