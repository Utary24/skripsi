        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800 text-center">Data Kendaraan</h1>
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <i class="nav-icon fas fa-file-excel"></i> &ensp; EXCEL</a>
                            ...
                            <a href="<?php echo base_url('kendaraan/create'); ?>" class="btn btn-outline-primary float-right"><i class="nav-icon fas fa-plus-square"></i>  Tambah Data</a>
                                ...
                                <tbody>
                                    <?php foreach ($kendaraan as $key => $row) { ?>
                                        <tr>
                                            ...
                                            <td>
                                                <div class="btn-group">
                                                    <a href="<?php echo base_url('kendaraan/edit/' . $row['kendaraan_id']); ?>" class="btn btn-sm btn-success">
                                                        <i class="fa fa-edit"></i>
                                                    </a>
                                                    <a href="<?php echo base_url('kendaraan/delete/' . $row['kendaraan_id']); ?>" class="btn btn-sm btn-danger" onclick="return confirm('Apakah Anda yakin ingin menghapus kategori ini?');">
